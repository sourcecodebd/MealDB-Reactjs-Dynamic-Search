...
const Foods = () => {
    ...
    const [search, setSearch] = useState(''); //dynamically set search string into url
        ...
        <div className="brand">
            <div className="brand-bg">
                <div className="container">
                    <div id="search">
                        <div className="send text-center my-2 border rounded">Total Meal: {meals?.length ? meals.length : 0}</div>
                        <li>
